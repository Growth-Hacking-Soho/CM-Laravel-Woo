                                                ...
                                                <table class="card-body" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
                                                            ...
                                                            <h1 style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px; margin: 0;" align="left">Has completado tu compra!</h1>
                                                                {{--{{ $details['name'] }}--}}
                                                            <h5 class="text-muted" style="color: #718096; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;" align="left">Completa la informacion de tu regalo</h5>
                                                            <h5>Tu URL para agregar los datos del mensaje es:</h5>
                                                            <p>http://127.0.0.1:8000/gift/{{ $id }}</p>
